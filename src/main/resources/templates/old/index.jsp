...
<section class="relative about-banner" id="home">
    ...
    <div class="col-lg-3 sidebar-widgets text-black " >
            ...
            <div class="single-sidebar-widget search-widget">
                <table >
                    ...
                    <c:forEach items="${currencies}" var="currency">
                        <tr>
                            <td class="country " class="block"> <img src="${currency.urlToPic}" alt="flag">   ${currency.name}</td>
                            <td><strong class="text-lg-right block">  -  ${currency.usd} USD</strong></td>
                        </tr>
                    </c:forEach>
